...
REPO = "**🗂️ SABKA BAAP :** [GANGSTER](https://t.me/VIKRANT_OP)\n\n🌟[Group](https://t.me/anokhi_dosti)  &  [Channel](https://t.me/about_riya)   📍**"
...
async def start(client, message):
    buttons = [
        [
        InlineKeyboardButton('📺 CHANNEL', url='https://t.me/HYPERS_CHAT_ROOM'),
        InlineKeyboardButton('🏘️ Group', url='https://t.me/HYPERS_CHAT_ROOM'),
    ],
    [
        InlineKeyboardButton('📑 land lele', url='xvideos.com'),
        InlineKeyboardButton('📜 GAND DEGA', url='https://jsjdjsjsjsjs'),
    ],
    [
